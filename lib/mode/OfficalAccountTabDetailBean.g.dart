...
part of 'OfficalAccountTabDetailBean.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

OfficalAccountTabDetailBean _$OfficalAccountTabDetailBeanFromJson(
    Map<String, dynamic> json) {
  return OfficalAccountTabDetailBean(
      json['data'] == null
          ? null
...
Map<String, dynamic> _$OfficalAccountTabDetailBeanToJson(
        OfficalAccountTabDetailBean instance) =>
    <String, dynamic>{
      'data': instance.data,
