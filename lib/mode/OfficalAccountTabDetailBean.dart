...
part 'OfficalAccountTabDetailBean.g.dart';


@JsonSerializable()
class OfficalAccountTabDetailBean{
  ...
  OfficalAccountTabDetailBean(this.data,this.errorCode,this.errorMsg,);

  factory OfficalAccountTabDetailBean.fromJson(Map<String, dynamic> srcJson) => _$OfficalAccountTabDetailBeanFromJson(srcJson);
