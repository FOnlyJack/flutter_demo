...
part 'NavigationDetailBean.g.dart';


@JsonSerializable()
class NavigationDetailBean {
  ...
  NavigationDetailBean(this.data,this.errorCode,this.errorMsg,);

  factory NavigationDetailBean.fromJson(Map<String, dynamic> srcJson) => _$NavigationDetailBeanFromJson(srcJson);
