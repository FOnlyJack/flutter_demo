...
part 'HomePageListDataBean.g.dart';


@JsonSerializable()
class HomePageListDataBean  {
  ...
  HomePageListDataBean(this.data,this.errorCode,this.errorMsg,);

  factory HomePageListDataBean.fromJson(Map<String, dynamic> srcJson) => _$HomePageListDataBeanFromJson(srcJson);
