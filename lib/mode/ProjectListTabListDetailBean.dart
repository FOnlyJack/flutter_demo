...
part 'ProjectListTabListDetailBean.g.dart';


@JsonSerializable()
class ProjectListTabListDetailBean {
  ...
  ProjectListTabListDetailBean(this.data,this.errorCode,this.errorMsg,);

  factory ProjectListTabListDetailBean.fromJson(Map<String, dynamic> srcJson) => _$ProjectListTabListDetailBeanFromJson(srcJson);
